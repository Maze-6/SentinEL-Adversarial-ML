"""
pipeline.py  (formerly app.py)
Author: Jeet Upadhyaya Anand
Role: Operational Pipeline & Threat Intelligence
Operational threat intelligence pipeline for SentinEL.
Responsibilities:
- High-velocity IOC feed ingestion using ThreadPoolExecutor (5x latency reduction)
- Real-time alert dispatching
- Dashboard and IOC triage integration
Complements Mourya's ML architecture (classifier.py) with operational
speed — ensuring detection results reach analysts before attack objectives are met.
"""
